...
public class Libro implements Serializable {
    ...
    private boolean isValidIsbn10(String isbn) {
        isbn = isbn.replaceAll("[\\s-]", ""); // Rimuove spazi e trattini
    ...
    /**
     * Contrassegna il libro come letto
     */
    public void segnaComeLetto() {
        this.stato = Stato.LETTO;
    }

    /**
     * Contrassegna il libro come in corso di lettura
     */
    public void segnaComeInCorso() {
        this.stato = Stato.IN_CORSO;
    }

    /**
     * Contrassegna il libro come da leggere
     */
    public void segnaComeDaLeggere() {
        this.stato = Stato.DA_LEGGERE;
    }
